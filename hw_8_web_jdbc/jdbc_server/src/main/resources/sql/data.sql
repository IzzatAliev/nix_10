insert into students values (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Christian', 'Bauer',18);
insert into students values (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Gavin', 'King', 22);
insert into students values (3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Gary', 'Gregory', 34);
insert into students values (4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Bruce', 'Lee', 42);
insert into students values (5, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Brian', 'Okay', 19);
insert into students values (6, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Tim', 'Bieber', 24);
insert into students values (7, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Anthony', 'Joshua', 26);
insert into students values (8, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Joseph', 'Johnson', 27);
insert into students values (9, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'David', 'Holmes',25);
insert into students values (10, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Doug', 'Lea', 37);
insert into students values (11, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Raul', 'Oaks', 36);
insert into students values (12, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Mario', 'Smith', 52);
insert into students values (13, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Alan', 'Brace', 38);
insert into students values (14, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Scott', 'Lebron', 21);
insert into students values (15, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Tomas', 'Shelby', 35);

insert into courses values (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'Linear Algebra and Geometry 3', 5, 'MATHEMATICS', 'What you''ll learn
...
insert into courses values (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'Become an Algebra Master', 4, 'MATHEMATICS', 'What you''ll learn
...
insert into courses values (3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'SC-300: Microsoft Identity and Access Administrator', 6, 'IT', 'What you''ll learn
Students will be prepared to take on the SC-300 exam
Students will learn on important security aspects in Azure such as protecting identities and managing access
Students will learn aspects which relate to the exam objectives
Students will also learn how to manage applications in Azure Active Directory' );

insert into courses values (4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'AZ-204 Developing for Microsoft Azure Exam Prep', 5, 'IT', 'What you''ll learn
...
insert into courses values (5, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'Physics - Kinematics for High School and AP Physics 1', 5, 'PHYSICS', 'What you''ll learn
Understand the major concepts of kinematics in 1 and 2 dimensions.');

insert into courses values (6, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'Classical Physics: Journey Through the Laws of the Universe', 6, 'PHYSICS', 'What you''ll learn
...
insert into courses values (7, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'Chemistry - Calculating Percentage Solutions', 4, 'CHEMISTRY', 'What you''ll learn
In this course is for biology, biomedical sciences, and chemistry students that need to learn how to calculate percentage solutions.
How to calculate weight by volume (w/v) percentage solutions.
How to calculate weight by weight (w/w) percentage solutions.
How to calculate volume by volume (v/v) percentage solutions.' );
insert into courses values (8, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'Animalist - zoology of animal 2', 5, 'BIOLOGY', 'What you''ll learn
Zoology, You will study animal kingdom in natural world');
insert into courses values (9, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'English Literature: Be as Informed as a Literature Graduate', 6, 'LITERATURE', 'What you''ll learn
...
insert into courses values (10, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),  'Fundamentals of Plastics and Polymers', 6, 'CHEMISTRY', 'What you''ll learn
...
insert into student_course values (7, 10);
insert into student_course values (8, 3);
insert into student_course values (9, 3);
insert into student_course values (9, 10);
insert into student_course values (10, 3);
insert into student_course values (7, 4);
insert into student_course values (7, 9);
insert into student_course values (11, 5);
insert into student_course values (12, 5);
insert into student_course values (13, 5);
insert into student_course values (14, 6);
insert into student_course values (14, 7);
insert into student_course values (15, 7);
insert into student_course values (15, 8);
