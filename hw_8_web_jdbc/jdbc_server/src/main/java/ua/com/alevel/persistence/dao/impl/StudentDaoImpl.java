...
public class StudentDaoImpl implements StudentDao {
    ...
    private static final String FIND_ALL_STUDENTS_BY_COURSE_ID_QUERY = "select * from students left join student_course sc on students.id = sc.student_id where sc.course_id =";
    ...
    public DataTableResponse<Student> findAll(DataTableRequest request) {
        ...
        String sql = "select id, first_name, last_name, age, count(student_id) as courseCount " +
    ...
    public List<Student> findAllByCourseId(Long courseId) {
        List<Student> students = new ArrayList<>();
        try(ResultSet resultSet = jpaConfig.getStatement().executeQuery(FIND_ALL_STUDENTS_BY_COURSE_ID_QUERY + courseId)) {
            while (resultSet.next()) {
